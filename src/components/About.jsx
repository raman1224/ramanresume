  ...
  const highlights = [
    {
      ...
      description: "Experienced in HTML, CSS, Tailwind CSS, JavaScript, TypeScript, React.js, Next js, Git, GitHub, and some backend technologies",
    },
    {
      icon: Lightbulb,
      title: "AI Innovation",
      description: "Creator of AI-powered Web applications including Newar Samaj, Medicare Nepal,  and Translator AI",
    },
    {
      icon: Users,
            ...
            <div className="mb-8">
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Aspiring Web Developer with experience in creating dynamic websites and applications through personal projects. Currently building my skills through projects including{" "}
                  <a
                  href="https://newarsamaj.vercel.app/"
                  target="_blank"
...
Newar Samaj              
   ...
   <a
                  href="https://medicare-nepal-e6k7.vercel.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary hover:text-secondary transition-colors duration-200 cursor-pointer font-semibold"
                >
                ...
                , and{" "}
                 <a
                  href="https://raman1224.github.io/englishtonepali/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary hover:text-secondary transition-colors duration-200 cursor-pointer font-semibold"
                >
Translator AI                </a> .
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Skilled in HTML, CSS, Tailwind CSS, JavaScript, TypeScript, React.js, Next js, C, Java, RESTful API, Git, GitHub, Vercel, API integration, and
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                <strong className="text-primary">Medicare Nepal</strong>
