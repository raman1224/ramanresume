...
const Education = () => {
  const education = [
    ...
    },
    {
      ...
      gpa: "3.52 / 4.0",
      status: "Completed",
      description: "Built strong foundation in computer Engineering fundamentals and programming concepts.",
      subjects: ["C++", "Java", "C-Sharp", "Mathematics", "Physics", "Chemistry"],
      current: false,
    },
  ]
